...
for K in range(2, 51):
    ...
    for i in range(10):
        ...
        if div_score_sum_nn(Best_solution, complete) > Best_max:
            Best_max = div_score_sum_nn(Best_solution, complete)
    ...
    for random_number in range(10):
        ...
        final_diversity = final_diversity + div_score_sum_nn(solution, complete) / 10
        final_alpha = final_alpha + ExactAlpha(complete, solution, fairradius) / 10
        final_ratio = final_ratio + div_score_sum_nn(solution, complete) / Best_max / 10
    end_time = time.time()
...
np.save("results/sum_min_div_CelebA.npy", np.array(div_CelebA))
np.save("results/sum_min_alpha_CelebA.npy", np.array(alpha_CelebA))
np.save("results/sum_min_ratio_CelebA.npy", np.array(ratio_CelebA))
np.save("results/sum_min_time_CelebA.npy", np.array(time_CelebA))
np.save("results/sum_min_div_glove.npy", np.array(div_glove))
np.save("results/sum_min_alpha_glove.npy", np.array(alpha_glove))
np.save("results/sum_min_ratio_glove.npy", np.array(ratio_glove))
np.save("results/sum_min_time_glove.npy", np.array(time_glove))
np.save("results/sum_min_div_movielens.npy", np.array(div_movielens))
np.save("results/sum_min_alpha_movielens.npy", np.array(alpha_movielens))
np.save("results/sum_min_ratio_movielens.npy", np.array(ratio_movielens))
np.save("results/sum_min_time_movielens.npy", np.array(time_movielens))
np.save("results/sum_min_div_gaussian.npy", np.array(div_gaussian))
np.save("results/sum_min_alpha_gaussian.npy", np.array(alpha_gaussian))
np.save("results/sum_min_ratio_gaussian.npy", np.array(ratio_gaussian))
np.save("results/sum_min_time_gaussian.npy", np.array(time_gaussian))
